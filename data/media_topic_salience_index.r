...
levels(as.factor(df_coded$filename))

## Filter df_coded for the the 1month, 3month and 6month files, as in the first draft, 2month files were included as well
allowed_filenames <- c(
    "H3_20230922 – 20231021",
    "H3_20230722 – 20230821",
    "H3_20230422 – 20230521"
)
df_coded %>%
    filter(filename %in% allowed_filenames) -> df_coded
...
## Write df_media_topic_salience_index to media_topic_salience_index.rds
saveRDS(df_media_topic_salience_index, "data/media_topic_salience_index.rds")
