...
\begin{abstract}
    This paper analyses the effect of financial resources of a party during an election and the party's salient issues on the media agenda. By giving an overview of the existing pertinent literature, two permises are formulated to build a framework that connects campaign funds to the public agenda through a theorized agenda-setting process. Hypotheses in regards to party activity and party relevance in the media and the connection of party issue salience and media issue salience are derived. Using a novel dataset including party earnings for the 2023 Swiss national election for the larger chamber of parliament is used, as well as over 40'000 articles from Swiss newspapers in the 6 months leading up to the election. In order to measure the relevant party positions, recent publications by the 5 largest parties in parliament are converted to plain text. The media articles and party positions are coded into 21 issue categories through the use of an artificially intelligent process, returning an index for media issue salience (\textit{MISI}) and party issue salience (\textit{PISI}). Testing the hypotheses delivered supportive evidence for the connection of party budgets and their relevance in the media. The hypotheses linking party budgets and party activity and the effect of the interaction between financial resources and party issue salience on the media agenda could not be tested conclusively.
\end{abstract}
